...
// Constructor
//
CBWPersistStream::CBWPersistStream(IUnknown *punk, __inout HRESULT *phr)
    : mPS_fDirty(FALSE)
{
...
// Destructor
//
CBWPersistStream::~CBWPersistStream() {
    // Nothing to do
}
...
STDMETHODIMP CBWPersistStream::NonDelegatingQueryInterface(REFIID riid, __deref_out void **ppv)
{
...
HRESULT CBWPersistStream::WriteToStream(IStream *pStream)
{
...
HRESULT CBWPersistStream::ReadFromStream(IStream * pStream)
{
    // You can override this to do things like
...
STDMETHODIMP CBWPersistStream::Load(LPSTREAM pStm)
{
    HRESULT hr;
...
STDMETHODIMP CBWPersistStream::Save(LPSTREAM pStm, BOOL fClearDirty)
{
